...
[go2_realrobot_gait_plan.md](go2_realrobot_gait_plan.md) を参照。
...
- `quadruped-gait` のビルドには `misarta`（`articara/misarta`）が必要。clone 済み。
...
## 8. 関連ドキュメント
- [go2_realrobot_gait_plan.md](go2_realrobot_gait_plan.md) — 設計・依存関係・チューニング結果
