#!/usr/bin/env python3
"""Replay the kyo46rs hanging-squat WBC trajectory log (torso welded in
mid-air, misa-wbc driving a real squat motion via the leg joints) by
directly setting MuJoCo qpos each frame, and encode to an mp4 via ffmpeg.
"""
import csv
import subprocess
import numpy as np
...
CSV_PATH = "/tmp/claude-1000/-home-takara-work/3288d9bb-da13-4665-bfb2-9595dd62f7ab/scratchpad/kyo46rs_hanging_squat_traj.csv"
FRAME_DIR = "/tmp/claude-1000/-home-takara-work/3288d9bb-da13-4665-bfb2-9595dd62f7ab/scratchpad/hanging_squat_frames"
OUT_MP4 = "/tmp/claude-1000/-home-takara-work/3288d9bb-da13-4665-bfb2-9595dd62f7ab/scratchpad/kyo46rs_hanging_squat.mp4"
...
# Torso is welded at z=0.9 and legs hang/swing below it -- frame the
# whole hanging figure (torso down through the feet), not the standing
# "torso + a bit of leg" framing the ground-standing render used.
cam.lookat[:] = [0, 0, 0.55]
cam.distance = 1.5
cam.azimuth = 55
cam.elevation = -8
